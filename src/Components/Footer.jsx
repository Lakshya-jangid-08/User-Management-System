        ...
        <div className='flex items-center gap-4 md:flex-row flex-col'>
            <div className='w-full  lg:w-1/4'>
                ...
                <div className='grid grid-cols-2 gap-4 mt-2'>
                    ...
                    <a href="https://www.facebook.com/share/12H6Apbj7gR/" className='flex justify-center items-center gap-2'>  <FaFacebook className='cursor-pointer' size={24}/> Facebook </a>
